...
\begin{abstract}
	...
	a ako veľmi by sa dala virtuálna výučba automatizovať. Ako by sa dala virtuálna výučba ešte viac 
...
Môže sa zdať, že problém vlastne nejestvuje\cite{2020}, ale bolo dokázané, že to tak nie je~\cite{Czarnecki:Staged, Czarnecki:Progress}. Napriek tomu, aj dnes na webe narazíme na všelijaké pochybné názory\cite{PLP-Framework}. Dôležité veci možno \emph{zdôrazniť kurzívou}.
